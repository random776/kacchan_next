      ...
      <div className="sonota">
        ...
        <div className="content">
          ...
          <p>
            ところで現在の
            <strong>
              学生自治会を含めた学生団体（以下学生自治会等）は、そのような背景を踏まえた上で建設的な議論が十分にできているのだろうか。
            </strong>
            私はかなり疑わしいと考える。
          </p>
          <p>
            残念ながら現在の学生自治会等は、学生側の論理と要求を強硬的に押し出す水掛け論を展開しているように思われてならない。9月11日の緊急声明で学生自治会は、「卑劣」「騙し討ち」といった強い表現を用いて大学側を強く非難した。[
            <a
              className="btn4"
            ...
            （それが自治会の伝統の文言なのかもしれないが）しかしながら大学の運営側同様、学生も大学の支出の恩恵をうけている大学の構成員であるのだから、ほんのわずかでも大学の出費を減らす協力姿勢を示すのが筋である（注1）。また、大学側が「対話」に応じようとしない、という趣旨のことを自治会が述べているが、そもそも自治会側もその「対話」に応じる気があるのか。本当に大学側と対話しようとするならば、「卑劣」などとは言わないはずである。
            そのような一方的主張に対して、大学側が誠実に「対話」を試みようとするかは、言わずもがなであると考える。
          </p>
          <p>
            また、これはごく一部の学生の話だが、安田講堂に侵入を試みて警備員を怪我させた件は記憶に新しい[
            <a
              className="btn4"
            ...
            ]。暴力的手段を用いることは、いかなる理由があっても許されないことである。学生自治会がデモにおける警察力の導入を非難している[
            <a
              className="btn4"
            ...
            。しかしそのような警察力の導入は、そのような基本的ルールを守らない学生がごく一部だがいることが背景にあるようにも思える。
          </p>
          <p>
            また、「東大の学費の値上げは、入学者の大学入学や教育の門戸を閉じることにつながる」という論が散見される。私も感覚的には頷けるのだが、根拠が明確でなく
            <strong>机上の空論感が否めず</strong>
            （注2）支援策の効果も考慮しなければならない。この点に東大の運営側は「実証はできず仮定の議論の域を出ません」と述べており、私は一理あると考えている。これを踏まえて学生自治会等は、
          </p>
          <ul>
            <li>
              水掛け論による強硬な反対表明に終始せず、学生側からも建設的な「対話」を試みる
            </li>
            <li>
          ...
          <ul>
            ...
            <li>
              やむを得ず値上げする場合は、より使途を明確にすること、また、経済支援策がどのような基準で適用されるのか具体的に示すこと
            </li>
          </ul>
          <p>
