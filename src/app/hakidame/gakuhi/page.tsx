      ...
      <div className="sonota">
        ...
        <div className="content">
          ...
          <p>
            ...
            しかしながら、学生も大学の支出の恩恵をうけている大学の構成員である。ほんのわずかでも大学の出費を減らす協力姿勢を示すのが筋である（注1）。
          </p>
          <p>
            また、大学側が「対話」に応じようとしない、という趣旨のことを自治会が述べているが、そもそも自治会側もその「対話」に応じる気があるのか。「卑劣」という物言いは、かえって「対話」に応じない者のセリフのように思えてならない。
          ...
          <p>
            ...
            。しかしそのような警察力の導入は、基本的ルールを守らない学生がごく一部だがいることが背景にあるようにも思える。
          </p>
          <p>
            また、「東大の学費の値上げは、入学者の大学入学や教育の門戸を閉じることにつながる」という論が散見される。私も感覚的には頷けるのだが、根拠が明確でなく
            <strong>机上の空論感が否めない</strong>
            （注2）。経済支援策の効果も考慮しなければ判断できない問題である。この点に東大の運営側は「実証はできず仮定の議論の域を出ません」と述べており、私はこの見解に一理あると考えている。
          </p>
          <p>これを踏まえて自治会等は、</p>
          <ul>
            <li>
          ...
          <ul>
            ...
            <li>
              やむを得ず値上げする場合は、より使途を明確にすること、また、経済支援策の適用基準（どんな人は支援を受けられて、どんな人が支援から漏れてしまうのか）具体的に示すこと
            </li>
          </ul>
          <p>
