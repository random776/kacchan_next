      ...
      <div className="sonota">
        ...
        <div className="content">
          ...
          <p>
            ...
            （注2）。経済支援策の効果も考慮しなければ判断できない問題である。この点に東大の運営側は「実証はできず仮定の議論の域を出ません」と述べており[3]、私はこの見解に一理あると考えている。
          </p>
          <p>これを踏まえて自治会等は、</p>
          <ul>
            <li>
          ...
          <ul>
            ...
            <li>
              やむを得ず値上げする場合は、より使途を明確にすること</li><li>経済支援策の効果を客観的に評価できるよう、適用基準（どんな人は支援を受けられて、どんな人が支援から漏れてしまうのか）を具体的に示すこと
            </li>
          </ul>
          <p>
