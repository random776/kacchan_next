          ...
          <div className="scroll_wrap">
            <div className="scroll_track">
              <span className="scroll_cont">
                <span style={{color: "blue"}}>★本サイト 仕様変更のお知らせ★</span>本サイトはこれまでViteで動かしていましたが、フレームワークを<span style={{color: "blue"}}>Next.js</span>に変更しました。（2024年9月14日）
              </span>
            </div>
          </div>
        </div>
        ...
        <div className="card_style">
          ...
          <div className="card_format">
            <div className="card card-skin">
              ...
              <div className="card__textbox">
                <div className="card__titletext">Kacchan Focus</div>
          ...
          <div className="card_format">
            <div className="card card-skin">
              ...
              <div className="card__textbox">
                <div className="card__utokyo">あの、東大さん、</div>
                <div className="card__utokyo">東大150周年まであと</div>
          ...
          <div className="card_format">
            <div className="card card-skin">
              <div className="card__imgframe">
                <img src="typing2.jpg" alt="" style={{ width: "100%" }} />
              </div>
              <div className="card__textbox">
                ...
                <span className="card-url">
                  <a
                    href="https://kacchan-typing.onrender.com"
                    className="btn4"
                  >
                    ページを開く
                  </a>
                ...
                <span className="card-url" style={{ left: "120px" }}>
                  <a
                    href="https://github.com/random776/touch-typing"
                    className="btn4"
                  >
                    ソースコードを見る
                  </a>
          ...
          <div className="card_format">
            <div className="card card-skin">
              <div className="card__imgframe">
                <img src="/natsuyasumi2.jpg" alt="" style={{ width: "100%" }} />
              </div>
              <div className="card__textbox">
                ...
                <span className="card-url">
                  <a
                    href="https://random776.github.io/natsuyasumi/"
                    className="btn4"
                  >
                    ページを開く
                  </a>
                ...
                <span className="card-url" style={{ left: "120px" }}>
                  <a
                    href="https://github.com/random776/natsuyasumi"
                    className="btn4"
                  >
                    ソースコードを見る
                  </a>
          ...
          <div className="card_format">
            <div className="card card-skin">
              ...
              <div className="card__textbox">
                ...
                <span className="card-url">
                  <a
                    href="https://github.com/random776/kyo_muka"
                    className="btn4"
                  >
                    ソースコードを見る
                  </a>
          ...
          <div className="card_format">
            <div className="card card-skin">
              ...
              <div className="card__textbox">
                ...
                <span className="card-url">
                  <a
                    href="https://ssic-decorator.onrender.com"
                    className="btn4"
                  >
                    ページを開く
                  </a>
                ...
                <span className="card-url" style={{ left: "120px" }}>
                  <a
                    href="https://github.com/random776/soft-cream"
                    className="btn4"
                  >
                    ソースコードを見る
                  </a>
          ...
          <div className="card_format">
            <div className="card card-skin">
              ...
              <div className="card__textbox">
                ...
                <span className="card-url">
                  <a
                    href="https://nauru-calendar.onrender.com"
                    className="btn4"
                  >
                    ページを開く
                  </a>
          ...
          <div className="card_format">
            <div className="card card-skin">
              ...
              <div className="card__textbox">
                ...
                <span className="card-url" style={{ left: "120px" }}>
                  <a
                    href="https://github.com/random776/tenkai"
                    className="btn4"
                  >
                    ソースコードを見る
                  </a>
          ...
          <div className="card_format">
            <div className="card card-skin">
              ...
              <div className="card__textbox">
                ...
                <span className="card-url">
                  <a
                    href="https://nshincalc-niki.onrender.com"
                    className="btn4"
                  >
                    ページを開く
                  </a>
                ...
                <span className="card-url" style={{ left: "120px" }}>
                  <a
                    href="https://github.com/random776/nshincalc_niki"
                    className="btn4"
                  >
                    ソースコードを見る
                  </a>
